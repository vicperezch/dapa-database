...
INSERT INTO orders (user_id, vehicle_id, client_name, client_phone, origin, destination, total_amount, details, status, type, date, submission_id) VALUES
(1, 1, 'Name', '12345678', 'New York', 'Boston', 150.00, 'Fragile items', 'delivered', 'move', '2023-01-01', 1),
(3, 2, 'Name', '12345678', 'Los Angeles', 'San Francisco', 200.00, 'Office furniture', 'pickup', 'corporate', '2023-01-02', 2),
(4, 3, 'Name', '12345678', 'Chicago', 'Detroit', 175.50, 'Personal belongings', 'assigned', 'cargo', '2023-01-03', 3),
(6, 4, 'Name', '12345678', 'Houston', 'Dallas', 120.75, 'Electronics', 'collected', 'move', '2023-01-04', 4),
(7, 5, 'Name', '12345678', 'Miami', 'Orlando', 90.00, 'Clothing', 'pending', 'cargo', '2023-01-05', 5),
(9, 6, 'Name', '12345678', 'Seattle', 'Portland', 210.25, 'Artwork', 'delivered', 'corporate', '2023-01-06', 6),
(10, 7, 'Name', '12345678', 'Denver', 'Phoenix', 300.00, 'Medical supplies', 'pickup', 'move', '2023-01-07', 7),
(12, 8, 'Name', '12345678', 'Atlanta', 'Nashville', 180.50, 'Music equipment', 'assigned', 'cargo', '2023-01-08', 8),
(13, 9, 'Name', '12345678', 'Boston', 'New York', 150.00, 'Documents', 'collected', 'corporate', '2023-01-09', 9),
(15, 10, 'Name', '12345678', 'San Francisco', 'Los Angeles', 200.00, 'Computer parts', 'pending', 'move', '2023-01-10', 10),
(16, 11, 'Name', '12345678', 'Detroit', 'Chicago', 175.50, 'Personal items', 'delivered', 'cargo', '2023-01-11', 11),
(1, 17, 'Name', '12345678', 'New York', 'Philadelphia', 130.00, 'Food products', 'pickup', 'cargo', '2023-01-17', 17),
(3, 18, 'Name', '12345678', 'Los Angeles', 'San Diego', 95.75, 'Beach equipment', 'assigned', 'corporate', '2023-01-18', 18),
(4, 19, 'Name', '12345678', 'Chicago', 'Milwaukee', 85.00, 'Office supplies', 'collected', 'move', '2023-01-19', 19),
(6, 20, 'Name', '12345678', 'Houston', 'Austin', 110.25, 'Music instruments', 'pending', 'cargo', '2023-01-20', 20),
(7, 21, 'Name', '12345678', 'Miami', 'Tampa', 140.00, 'Art supplies', 'delivered', 'corporate', '2023-01-21', 21),
(9, 22, 'Name', '12345678', 'Seattle', 'Vancouver', 250.50, 'Sport equipment', 'pickup', 'move', '2023-01-22', 22),
(10, 23, 'Name', '12345678', 'Denver', 'Salt Lake City', 220.75, 'Camping gear', 'assigned', 'cargo', '2023-01-23', 23),
(12, 24, 'Name', '12345678', 'Atlanta', 'Charlotte', 160.00, 'Electronics', 'collected', 'corporate', '2023-01-24', 24),
(13, 25, 'Name', '12345678', 'Boston', 'Washington DC', 190.25, 'Important documents', 'pending', 'move', '2023-01-25', 25);
